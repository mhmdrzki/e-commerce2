...
<div class="row-fluid inbox">
					...
					<div class="span10">
						...
						<div class="inbox-compose form-horizontal" >
							...
							<div class="inbox-control-group">
								<textarea class="span12  wysihtml5 m-wrap" name="isi_pesan_kirim" id="isi_pesan_kirim" rows="12"></textarea>
							</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
				...
				$("#isi_pesan_terkirim").focus();
                            ...
                            if (!email_check[1] || !email_check2[0] || !email_check2[1]) {
                                ...
                                return false;
                            	 ...
                            	 $.ajax({
                                    type:"POST",
                                    url :"<?php echo base_url();?>adminweb/pesan_add_simpan",
		...
		$("#inbox").click(function(){
			...
			window.location.href="<?php echo base_url();?>adminweb/pesan";
		});
	})
</script>